...
install -p -D -m 640 %{_sysconfdir}%{service}/api-paste.ini \
                     %{buildroot}%{_sysconfdir}/%{service}/api-paste.ini
install -p -D -m 640 %{_sysconfdir}%{service}/policy.json \
...
%files
%license LICENSE
%{_bindir}/openstack-senlin-api
%{_bindir}/openstack-senlin-engine
